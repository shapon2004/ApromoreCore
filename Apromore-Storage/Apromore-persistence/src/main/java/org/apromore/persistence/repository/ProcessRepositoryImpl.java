...
import static org.apromore.persistence.entity.Group.Type.PUBLIC;
...
public class ProcessRepositoryImpl implements ProcessRepositoryCustom {
    ...
    /**
     * @see org.apromore.persistence.repository.ProcessRepositoryCustom#findAllProcesses(String)
     * {@inheritDoc}
     */
    @Override
    ...
    /**
     * @see org.apromore.persistence.repository.ProcessRepositoryCustom#findAllProcessesByFolder(Integer, String)
     * {@inheritDoc}
     */
    @Override
    @SuppressWarnings("unchecked")
