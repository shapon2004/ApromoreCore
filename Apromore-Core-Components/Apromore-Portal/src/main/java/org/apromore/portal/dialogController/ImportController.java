...
public class ImportController extends BaseController {
  ...
  public ImportController(MainController mainC) throws DialogException {
    ...
    try {
      ...
      List<FileImporterPlugin> fileImporterPlugins =
          (List<FileImporterPlugin>) SpringUtil.getBean("fileImporterPlugins");
  ...
  void importFile(Media importedMedia)
    ...
    } else if (name.toLowerCase().endsWith("xes") || name.toLowerCase().endsWith("xes.gz")
        || name.toLowerCase().endsWith("mxml") || name.toLowerCase().endsWith("mxml.gz")) {
