...
public abstract class BaseListboxController extends BaseController {
  ...
  private static final String FOLDER_DELETE =
      "Are you sure you want to delete selected folder(s) and all it's contents?";
  private static final String LOG_DELETE = "Are you sure you want to delete selected log(s)?";
  private static final String PROCESS_DELETE =
      "Are you sure you want to delete the selected process model(s)? If no version has been selected, the latest version will be removed.";
  private static final String MIXED_DELETE =
      "Are you sure you want to delete the selected file(s)? For a process model, if no version has been selected, the latest version will be removed.";
