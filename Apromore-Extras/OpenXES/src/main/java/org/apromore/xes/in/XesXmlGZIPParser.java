...
public class XesXmlGZIPParser extends XesXmlParser {
	...
	/* (non-Javadoc)
	 * @see XesXmlParser#canParse(java.io.File)
	 */
	@Override
...
//		}
	...
	/* (non-Javadoc)
	 * @see XesXmlParser#parse(java.io.InputStream)
	 */
	@Override
