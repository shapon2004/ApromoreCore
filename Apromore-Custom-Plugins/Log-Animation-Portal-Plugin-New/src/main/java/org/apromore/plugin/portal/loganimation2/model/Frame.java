...
public class Frame {
    ...
    public int getTokenCount(int tokenIndex) {
        return tokenCountMap.containsKey(tokenIndex) ? tokenCountMap.get(tokenIndex) : 1;
    }
    ...
    private JSONArray getTokenJSON(int tokenIndex) throws JSONException {
        ...
        attJSON.put(this.getTokenCount(tokenIndex));
        return attJSON;
    }
}
