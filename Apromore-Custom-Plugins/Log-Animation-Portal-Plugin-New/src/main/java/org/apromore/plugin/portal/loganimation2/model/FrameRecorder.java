...
public class FrameRecorder {
	public static Movie record(AnimationLog log, AnimationIndex animationIndex, AnimationContext animationContext) {
		Movie movie = new Movie(animationContext, animationIndex);
		...
		movie.parallelStream().forEach(frame -> frame.clusterTokens());
