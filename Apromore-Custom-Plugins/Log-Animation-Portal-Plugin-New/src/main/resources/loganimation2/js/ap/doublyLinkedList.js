/**
 * Double Linked List from https://github.com/humanwhocodes/computer-science-in-javascript
 */
...
class DoublyLinkedList {
    ...
    /**
     * Remove multiple items from the head
     * @param {Number} removeSize: number of items to be removed
     */
    removeAtHead(removeSize) {
