...
public class Crypto implements CryptoService {
  ...
  public Crypto(String secret, boolean isEncrptionEnabled) {
    this.secret = secret;
    this.isEncryptionEnabled = isEncrptionEnabled;
    textEncryptor = new BasicTextEncryptor();
    textEncryptor.setPasswordCharArray(secret.toCharArray());
  }

  @Override
  public String getPassword(String encryptedString) {
  ...
  @Override
  public String getEncryptedPasswordString(String rawPassword) {
