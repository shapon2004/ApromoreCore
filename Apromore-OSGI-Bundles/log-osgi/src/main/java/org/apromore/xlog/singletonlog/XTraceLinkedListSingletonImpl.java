...
public class XTraceLinkedListSingletonImpl extends LinkedList<org.apromore.xes.model.XEvent> implements XTrace {
    private static final long serialVersionUID = 843122019760036963L;
    private org.apromore.xes.model.XAttributeMap attributes;

    public XTraceLinkedListSingletonImpl(org.apromore.xes.model.XAttributeMap attributeMap) {
